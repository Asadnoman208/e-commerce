...
let TokenValidationMiddleware = class TokenValidationMiddleware {
    ...
    use(req, res, next) {
        ...
        try {
            ...
            throw new common_1.HttpException({ status: 'error', message: 'INVALID_TOKEN' }, common_1.HttpStatus.UNAUTHORIZED);
        }
    }
};
exports.TokenValidationMiddleware = TokenValidationMiddleware;
exports.TokenValidationMiddleware = TokenValidationMiddleware = __decorate([
